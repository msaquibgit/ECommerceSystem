...
{
    /// <inheritdoc />
    public partial class ProductServiceMg1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "ProductImages",
                columns: new[] { "Id", "AltText", "CreatedOn", "ImageUrl", "IsActive", "IsPrimary", "ModifiedOn", "ProductId" },
                values: new object[,]
                {
                    { new Guid("c6d7e8f9-be2f-4f67-c032-789abcdef013"), null, new DateTime(2025, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), "https://example.com/images/headphones_pro.jpg", false, true, null, new Guid("e2f3d4c5-7a8b-4b23-8d9e-3c456789abcd") },
                    { new Guid("d7e8f901-cf30-5068-d143-89abcdef0123"), null, new DateTime(2025, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), "https://example.com/images/smart_tv_55.jpg", false, true, null, new Guid("f3a4b5c6-8b9c-4c34-9e0f-4d56789abcde") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("e8f901a2-d041-6179-e254-9abcdef01234"), null, new DateTime(2025, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), "https://example.com/images/smartphone_x1_front.jpg", false, true, null, new Guid("a4b5c6d7-9c0d-4d45-af10-5e6789abcdef") },
                    { new Guid("f901a2b3-e152-728a-f365-abcedf012345"), null, new DateTime(2025, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), "https://example.com/images/budget_smartphone_z5.jpg", false, true, null, new Guid("b5c6d7e8-ad1e-4e56-bf21-6f789abcdef0") }
                });
